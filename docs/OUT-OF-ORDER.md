...
| GL extract before recon | BKGL01 / BKGL02 RECON_CLOSED | RC=8 |
...
| Process GDG(-1) as current | BKGDG01 header vs cycle vs gen | RC=12 BK-E-CUTOFF |
| Three-way before location recon | BKRCN03 VALIDATED_IND | RC=8 NOT-VALID |
| ACH live file with prenote amount | BKACH01 tx 23/28 | RC=12 PRENOTE-MUST-ZERO |
